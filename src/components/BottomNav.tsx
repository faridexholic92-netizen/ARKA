...
import { LayoutDashboard, Users, TrendingUp, Heart, Trophy } from "lucide-react";
        ...
        {items.map((item) => {
          ...
          return (
            ...
            >
              ...
              <span className={cn("text-[10px] font-medium", active ? "text-blue-600" : "text-gray-400")}>{item.label}</span>
            </Link>
          );
        })}
      </div>
